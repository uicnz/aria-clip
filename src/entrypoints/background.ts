...
import { updateCurrentActiveTab, isValidUrl, isBlankPage, isNormalPageUrl } from '../platform/browser/active-tab-manager.js';
import { TextHighlightData } from '../features/highlights/highlighter.js';
