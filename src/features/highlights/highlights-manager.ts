...
import { AnyHighlightData, ElementHighlightData, HighlightsStorage, TextHighlightData, TextQuoteAnchor, buildExportedPage, collapseGroupsForExport, expandExportedEntries, normalizeUrl, reconcileLegacyUrlKey } from './highlighter.js';
import { showImportModal } from '../settings/import-modal.js';
			...
			if (navigator.share) {
				try {
					await navigator.share({
						...
						text: 'Here are your exported highlights from Aria Clip.'
					});
				} catch (error) {
