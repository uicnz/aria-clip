...
import { getElementXPath, getElementByXPath, setElementHTML } from '../../shared/dom/dom-utils.js';
import {
	handleMouseUp,
...
import { detectBrowser, addBrowserClassToHtml } from '../../platform/browser/browser-detection.js';
