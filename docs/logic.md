...
description: Use conditionals, loops, and variable assignment in Clip templates.
---

[[Introduction to Aria Clip|Clip]] supports template logic for conditionals, loops, and variable assignment. This syntax is inspired by [Twig](https://twig.symfony.com/) and [Liquid](https://shopify.github.io/liquid/) templating languages.
