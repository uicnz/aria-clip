...
Aria Clip documentation is organized by audience.

## Operator

[`operator/`](operator/) explains the product as a user and template author encounters it: capture, highlights, interpretation, templates, location, variables, filters, logic, and troubleshooting.

Start with [Aria Clip](operator/introduction.md).
